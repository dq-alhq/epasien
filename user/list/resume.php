...
if (isset($norawat["norawat"])) {
    ...
    if ($rsqueryresume = mysqli_fetch_array($queryresume)) { ?>
        <div class="text-center mb-3">
            <h5 class="menu-header-title mb-1"><strong>RESUME PERAWATAN</strong></h5>
            ...
            <div class='panel-group' id='accordion_4' role='tablist' aria-multiselectable='true'>
                    ...
                    <div class='panel-heading' role='tab' id='headingTwo_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseOne_4' aria-expanded='false'
                ...
                <div class='panel panel-col-pink'>
                    <div class='panel-heading' role='tab' id='headingTwo_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseTwo_4' aria-expanded='false'
                                aria-controls='collapseTwo_4'>
                                Jalannya Penyakit Selama Perawatan
                            </a>
                        </h4>
                    </div>
                    <div id='collapseTwo_4' class='panel-collapse collapse' role='tabpanel'
                ...
                <div class='panel panel-col-pink'>
                    <div class='panel-heading' role='tab' id='headingThree_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseThree_4' aria-expanded='false'
                ...
                <div class='panel panel-col-pink'>
                    <div class='panel-heading' role='tab' id='headingFour_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseFour_4' aria-expanded='false'
                ...
                <div class='panel panel-col-pink'>
                    <div class='panel-heading' role='tab' id='headingFive_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseFive_4' aria-expanded='false'
                                aria-controls='collapseFive_4'>
                                Diagnosa Akhir
                            </a>
                        </h4>
                    </div>
                    <div id='collapseFive_4' class='panel-collapse collapse' role='tabpanel'
                        aria-labelledby='headingFive_4'>
                        <div class='panel-body'>
                            <div class='table-responsive'>
                                <table width='100%' class='table table-hover dataTable'>
                                    <tr align='left'>
                                        <td width='20%'>Diagnosa Utama</td>
                                        <td width='70%'>:&nbsp;<?= $rsqueryresume["diagnosa_utama"] ?></td>
                                        <td width='10%'>
                                            &nbsp;<?= $rsqueryresume["kd_diagnosa_utama"] ?></td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Diagnosa Sekunder 1</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["diagnosa_sekunder"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_diagnosa_sekunder"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Diagnosa Sekunder 2</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["diagnosa_sekunder2"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_diagnosa_sekunder2"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Diagnosa Sekunder 3</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["diagnosa_sekunder3"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_diagnosa_sekunder3"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Diagnosa Sekunder 4</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["diagnosa_sekunder4"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_diagnosa_sekunder4"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Prosedur Utama</td>
                                        <td width='70%'>:&nbsp;<?= $rsqueryresume["prosedur_utama"] ?></td>
                                        <td width='10%'>
                                            &nbsp;<?= $rsqueryresume["kd_prosedur_utama"] ?></td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Prosedur Sekunder 1</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["prosedur_sekunder"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_prosedur_sekunder"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Prosedur Sekunder 2</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["prosedur_sekunder2"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_prosedur_sekunder2"] ?>
                                        </td>
                                    </tr>
                                    <tr align='left'>
                                        <td width='20%'>Prosedur Sekunder 3</td>
                                        <td width='70%'>
                                            :&nbsp;<?= $rsqueryresume["prosedur_sekunder3"] ?></td>
                                        <td width='10%'>&nbsp;<?= $rsqueryresume["kd_prosedur_sekunder3"] ?>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class='panel panel-col-pink'>
                    <div class='panel-heading' role='tab' id='headingSix_4'>
                        <h4 class='panel-title'>
                            <a class='collapsed' role='button' data-toggle='collapse'
                                data-parent='#accordion_4' href='#collapseSix_4' aria-expanded='false'
                                aria-controls='collapseSix_4'>
                                Obat-obatan Waktu Pulang/Nasihat
                            </a>
                        </h4>
                    </div>
                    <div id='collapseSix_4' class='panel-collapse collapse' role='tabpanel'
                        aria-labelledby='headingSix_4'>
                        <div class='panel-body'>
    ...
    <?php } else { ?>
        <div class="text-center mb-3">
            <h5 class="menu-header-title mb-3"><strong>RESUME PERAWATAN</strong></h5>
        </div>
        <div class='card card-body text-center'>
            <p>Maaf resume perawatan dengan No.Rawat <?= $norawat; ?> belum keluar, masih menunggu
                dikeluarkan
                oleh dokter DPJP.
            </p>
            <center><a href='?act=RiwayatPeriksa&hal=RiwayatPeriksa'
    ...
    <?php JSRedirect2("?act=RiwayatPeriksa", 7);
    }
} else { ?>
    <div class='block-header'>
        <h2>
            <center>RESUME PERAWATAN</center>
        </h2>
    </div>
    <div class='card card-body text-center'>
        <p>Maaf resume perawatan tidak ditemukan</p>
        <br />
        <center><a href='index.php?act=RiwayatPeriksa&hal=RiwayatPeriksa'
                class='btn btn-danger waves-effect'>Kembali</a></center>
    </div>
<?php JSRedirect2("index.php?act=RiwayatPeriksa", 4);
} ?>
